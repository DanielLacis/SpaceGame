(function() {
  ...
  SpaceGame.GameView.prototype.clearView = function () {
  ...
  SpaceGame.GameView.prototype.drawCircle = function(options) {
  ...
  SpaceGame.GameView.prototype.drawPlayerBullets = function(drawOptionsArray) {
    var drawOptions;
  ...
  SpaceGame.GameView.prototype.drawPlayerShip = function(drawOptions) {
    this.drawCircle(drawOptions);
  };
